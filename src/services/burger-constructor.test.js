import { addBun, addIngredient, constructorIngredientsSlice, deleteIngredient, initialState, resetIngredients, setIngredients } from "./burger-constructor";
...
describe('constructorIngredientsSlice reducers check', () => {
   ...
   it('correct initial state', () => {
      const state = constructorIngredientsSlice.reducer(undefined, { type: undefined });
   ...
   it('addIngredient', () => {
      ...
      const action = { type: addIngredient.type, payload: { ...testIngredient, key: "test-key" } };

      const state = constructorIngredientsSlice.reducer(initialState, action);

      expect(state).toEqual({ ...initialState, constructorIngredients: [{ ...testIngredient, key: "test-key" }] })
   });
   ...
   it('setIngredients', () => {
      ...
      expect(state).toEqual({ ...initialState, constructorIngredients: ingredients });
   });
