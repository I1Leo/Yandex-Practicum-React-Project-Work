...
const testLoginResponse = {
	success: true,
	accessToken:
		'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY2ZjA2MDkyMTE5ZDQ1MDAxYjUwODY5OSIsImlhdCI6MTczMTYwMzUwOCwiZXhwIjoxNzMxNjA0NzA4fQ.OhdJrSMBxMJLsFEJlbYFgU5sU6hvD5RtKAZl4OcgfZw',
	refreshToken:
		'9411187227d941f82895eac20f98f2a7d0b503badf080de4c231354554e9fabd065edf0b6f2ed53d',
	user: {
		email: '123@yandex.ru',
		name: 'testUserName',
	},
...
describe('authSlice reducers check', () => {
	...
	it('updateUser fulfilled', () => {
		const action = {
			...
			payload: testUpdateUserResponse,
		};
