import { activateOrderDetailsModal, deactivateOrderDetailsModal, getOrder, initialState, orderDetailsSlice } from "./order-details";
...
describe("orderDetailsSlice reducers check", () => {
   ...
   it("deactivateOrderDetailsModal", () => {
      ...
      expect(state).toEqual({...initialState, isOrderDetailsModalActive: false})
   })
   ...
   it("getOrder pending", () => {
      ...
      expect(state).toEqual({ ...initialState, orderRequest: true,  orderFailed: false});
   })
   ...
   it("getOrder  fullfiled", () => {
      ...
      expect(state).toEqual({...initialState, orderRequest: false, order: testOrder})
   })
