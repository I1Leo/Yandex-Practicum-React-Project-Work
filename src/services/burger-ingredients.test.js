import { ingredientsSlice, initialState, getIngredients } from "./burger-ingredients";
...
describe("ingredientsSlice reducers check", () => {
   ...
   it("getIngredients fullfiled", () => {
      ...
      expect(state).toEqual({...initialState, ingredientsRequest: false, ingredients: testIngredients})
   })
