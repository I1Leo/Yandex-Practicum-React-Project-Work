describe("Constructor", () => {
   ...
   it("Should drag ingredient to the constructor section", () => {
      ...
      cy.get('[data-testid = constructor-section]').find("[data-testid = Ingredient-0]").should("exist");
      cy.get('[data-testid = constructor-section]').find("[data-testid = Ingredient-1]").should("exist");
      cy.get('[data-testid = constructor-section]').find("[data-testid = Ingredient-2]").should("exist");
   })
